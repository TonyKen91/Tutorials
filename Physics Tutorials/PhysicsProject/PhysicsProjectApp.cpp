...
///////////////////////////////////////////////////
	...
	Box* border2 = new Box(vec2(borderWidth/2.0f, 0), vec2(0, 0), 10.0f, borderHeight, 10, vec4(1, 1, 1, 1));
...
void PhysicsProjectApp::update(float deltaTime) {
	...
	{
		Box* playerBox = new Box(vec2(mouseX, mouseY), vec2(0, 0), 10.0f, 2.0f*1.9f, 2.0f*1.9f, vec4(1, 0, 0, 1), 0, 0);
		playerBox->setDespawnTimer(5);
		m_gameScene->addActor(playerBox);
		ballNumber++;
	}
